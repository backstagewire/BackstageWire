...
export default function DispatchPage() {
  const items = stories.filter((story) => story.section === "dispatch");
  ...
  return (
    <main className="bg-[#070914] text-white">
      <section className="mx-auto max-w-6xl px-4 py-12 md:px-6">
        ...
        <h1 className="mt-3 text-4xl font-bold">Quick artist Q&As with a recognizable format</h1>
        <p className="mt-3 max-w-2xl text-white/65">
          A recurring feature built to be personal, repeatable, and shareable.
        </p>
